...
中文版见[功能设计文档索引](../../zh/features/index.md).

Design documents for subsystems with non-trivial decisions. Small changes
live in the [CHANGELOG](../../../CHANGELOG.md) only.
...
> summarized initial release (2026-08-27) per the
> [CHANGELOG](../../../CHANGELOG.md) convention. Future features will enter
